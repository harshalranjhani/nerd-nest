  ...
  return (
    <div className='m-10'>
      <Card x-chunk="dashboard-04-chunk-1">
        ...
        <CardContent>
            This key is not stored on the server. It is encrypted and stored in your browser. It is used for the AI assistant in the chat. Without this key, the AI assistant will not work.
        </CardContent>
